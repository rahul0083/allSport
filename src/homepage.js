...
const Homepage = () => {
  ...
  return (
    <>
        ...
        <div className="position-absolute w-100">
          ...
          <Row className="mt-5 ms-5">
            <Col className="ms-5 d-flex flex-column justify-content-center">
              ...
              <p className="font-paris2024 text-start text-white ">
                Games, Uttarakhand
              </p>
              <p className="font-paris2024 text-start text-white ">2024</p>
              ...
              <button className="text-center rounded-pill col-4 p-2">
                UTTARAKHAND UNLEASHED
              </button>
            </Col>
            <Col className="ms-5 d-flex flex-column justify-content-center mt-5">
              <button
                className="text-center rounded-3 col-4 p-2"
                style={{ background: " rgba(215, 195, 120, 1)" }}
              >
                Live Registration
              </button>
              <p className="text-white fw-bold col-4 mt-3">
      ...
      {/* SCHEDULE */}
      <div className="medal-tally mt-4 p-4">
      ...
      <div className="bg-ultraLightGray py-11 mt-5">
        <h3 className="display-3 fw-normal mascot-text text-center mb-9 text-capitalize">
          GAMES PARTNERS
        </h3>
            ...
            <a href="#">
              <div className="bg-transparent border-0 text-center card">
                <div className="p-0 card-body">
                  <img
                    className="card-img-top"
                    src="../Ministry_of_Youth_Affairs_and_Sports 2.svg"
                  />
                </div>
              </div>
            </a>
