...
<footer className="pt-lg-10 pt-5 footer">
  <div className="pb-0">
    <div className="row">
      ...
      <div className="offset-lg-1 col-lg-2 col-md-3 col-6 col-md-3">
        <div className="mb-4">
      ...
      <div className="col-lg-2 col-md-3 col-6 col-md-3">
        <div className="mb-4">
    ...
    <div className="align-items-center g-0 border-top border-white py-6 mt-6 row">
      <div className="col-12 text-center text-white col-md-12">
